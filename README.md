...
> **一套从嵌入式物理世界淤青中长出的 AI 工程化方法论，以及它向生活、关系与创作边界的自然外延。**
>
> 我是 **itg**，**火星火箭**。这里的主体是嵌入式 AI 工程化文章：如何借 AI 的力打代码的 Bug，驯复杂系统的野兽，建立可收敛、可验证、可进化的方法论。更准确地说，这里讨论的不是某项具体技术，而是一套可以跨领域复现的**顶层范式**。至于关于作者、关系、小说与创作的部分，不是另一条平行主线，而是同一套范式在生活和表达层面的应用与验证。
...
如果只用一句话概括这套体系，那就是：**它不是解决某一个问题的技巧，而是定义一类复杂问题该如何被拆解、观测、收敛与验证的顶层范式。**

---

## 🧭 站点坐标

这个站点不是纯技术手册，也不是生活随笔合集，而是把一套工程法则从物理世界一路推演到生活、小说与创作方法的四层结构。

- **没有"全面碾压"的同类型站点**：但在纯技术深度、行业影响力、长期沉淀与跨域融合成熟度上，确实有一批值得长期对标的优秀独立博客。
- **技术深度的对标方向**：痞子衡、Embedded Artistry、Interrupt Blog 这类站点，代表了底层工具链、固件架构、调试与可观测性的高标准。
- **技术与人文的对标方向**：小土刀 2.0 代表的是更成熟的长文思辨密度与克制文风。
- **元创作的对标方向**：陈素封提醒我，创作过程本身也能被提炼成长期方法论。
- **这座站点真正独特的部分**：硬件淤青 → 工程心法 → 生活关系 → 小说实验 → 元创作公开，这条完整链路目前仍然很少见。
...
<details>
<summary>③ 自主修复闭环：双轨收敛剑</summary>

> 一剑修 Bug，一剑补测试，两剑齐出，螺旋上升。AI 会自己看日志、自己改、自己再测——直到没问题。
>
...
<details>
<summary>④ 从收敛到进化：Agent 性格制衡</summary>
...
<details>
<summary>⑤ 知识的生命体征：秘笈也要养护</summary>
...
<details>
<summary>⑥ 电路图分析器：打通任督二脉</summary>

> 从此 AI 能读懂电路图，看见物理世界的经络。你点一下元件，它就能跳到对应的代码行——如臂使指。
>
...
<details>
<summary>⑦ 最后的拼图：Skills 快剑诀</summary>

> 日常高频的需求，像飞镖一样随手甩出，瞬间生成。I2C 驱动、GPIO 配置、报警阈值……信手拈来，不再费神。
>
...
<details>
<summary>⑧ 历史的包袱：老项目也能入门派</summary>
...
>
> [阅读全文](https://x-itg.github.io/py.html)
...
>
> 胜了，继续拼下一块；败了，问题就在新拼的那块上，揪出来再打。这是乾坤大挪移的高阶奥义——**借力打力，化繁为简**。
>
...
>
> [阅读全文](https://x-itg.github.io/gd.html)
...
这不是一排随手记下来的生活片段。它更像一张逐层展开的地图：先在工程里定义法则，再用生活去验证它，接着在文学里承认它的边界，最后把整套创作引擎公开出来。

### Layer 1 · 理论层 · 法则的建立

先把那些在深夜调试里摸到的规律写清楚，变成可复用的思维工具。
...
法则不只活在代码里，也活在家里、关系里、疲惫里，活在一个人每天怎么过日子里。
...
当法则遇到感情、错配和失控，它不再只是方法论，而开始长出故事；当故事继续推进，法则的边界、代价与余波也被一步步写出来。
...
| `[方法论]` 🔧 [我不用天赋，我只用方法](https://x-itg.github.io/aboutmore/ng.html) | 用工程方法论驾驭创作与设计，不依靠直觉与灵感 |
...
这套体系，不是教程，也不是作品集。是一个工程师在AI时代，用他全部的逻辑和全部的脆弱，为自己建的一座殿堂。技术文章是柱子，生活随笔是窗，小说是站在中央的人。
若你也是那个在深夜独对屏幕的侠客，这套心法，或许能让你少走几段夜路。

**言出法随，即刻收敛。**
—— itg，火星火箭，乾坤大挪移传人。

> 始于工程，穿过生活，抵达文学，然后在元创作里解释自己。
