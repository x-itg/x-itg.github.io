...
> 当前十四篇文章把法则铺进了工程，这一篇回头解释它们为什么不会随着模型能力增长而失效。会过时的是“给AI补短板”的具体补丁，不会过时的是它背后的思维方式：定义边界、感知异常、闭环修正、决策切换。
>
...
| `[索引]` 🧭 [乾坤大挪移心法 · 文章总览](https://x-itg.github.io/aboutmore/wx.html) | 十五篇技术文章一篇看完 |
...
当法则遇到感情、错配和失控，它不再只是方法论，而开始长出故事。
