...
TECH_ITEMS = [
    ("index.html", "🧭", "五层进化", "总纲 · 定义整个体系的坐标系和成熟度框架"),
...
GROUPS = [
    ...
    ("核心主线", TECH_ITEMS[1:5]),
    ("根系能力", TECH_ITEMS[5:7]),
    ("专业延伸", [TECH_ITEMS[7], TECH_ITEMS[8], TECH_ITEMS[9], TECH_ITEMS[14]]),
    ("实战与心法", TECH_ITEMS[10:14]),
    ("内核反照", [TECH_ITEMS[15]]),
]
...
SECTION_META = {
    "index.html": ("技术主线 · 总纲", "定义体系坐标，后续所有工程法则都从这里分叉。"),
